...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'forail.sqlite3'),
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [  # NOQA
                ...
                'forail.ui.context_processors.csp',
                'forail.ui.context_processors.version',
                'social_django.context_processors.backends',
                'social_django.context_processors.login_redirect',
            ],
            'builtins': ['forail.main.templatetags.swagger'],
        },
        'DIRS': [
...
ROOT_URLCONF = 'forail.urls'

WSGI_APPLICATION = 'forail.wsgi.application'
...
MIDDLEWARE = [
    ...
    'forail.main.middleware.SettingsCacheMiddleware',
    # Request timing/profiling (lightweight when AWX_REQUEST_PROFILE=False)
    'forail.main.middleware.TimingMiddleware',
    ...
    'forail.main.middleware.MigrationRanCheckMiddleware',
    'django.middleware.locale.LocaleMiddleware',
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    # Must be after AuthenticationMiddleware - needs request.user
    'forail.main.middleware.DisableLocalAuthMiddleware',
    # Enforces org-level WebAuthn MFA after primary auth
    'forail.main.middleware.WebAuthnMfaEnforcementMiddleware',
    # Multi-Tenancy v2: sets Postgres forail.current_tenant_id for RLS
    'forail.main.tenancy.isolation.TenantIsolationMiddleware',
    # Multi-Tenancy v2: per-tenant API rate limiting (token bucket / Redis)
    'forail.main.tenancy.rate_limit.TenantRateLimitMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    # URL routing based on optional prefix
    'forail.main.middleware.OptionalURLPrefixPath',
    # Social auth handling (extends SocialAuthExceptionMiddleware)
    'forail.sso.middleware.SocialAuthMiddleware',
    ...
    'forail.main.middleware.URLModificationMiddleware',
    # Session timeout refresh - must be last to set response headers
    'forail.main.middleware.SessionTimeoutMiddleware',
]
