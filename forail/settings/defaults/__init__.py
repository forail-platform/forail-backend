...
from .forail_settings import *  # noqa: F401,F403
...
ANSIBLE_BASE_RESOURCE_CONFIG_MODULE = 'forail.resource_api'
...
ANSIBLE_BASE_CUSTOM_VIEW_PARENT = 'forail.api.generics.APIView'
