...
COLOR_LOGS = True
LOGGING['handlers']['console']['()'] = 'forail.main.utils.handlers.ColorHandler'  # noqa
...
# Only works in combination with settings.SETTINGS_MODULE == 'forail.settings.development'
