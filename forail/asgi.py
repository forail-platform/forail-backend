...
import logging
import django
from forail import __version__ as tower_version

# Prepare the Forail environment.
from forail import prepare_env, MODE
...
"""
ASGI config for Forail project.
...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "forail.settings")
django.setup()

# Observability: no-op when OTEL_ENABLED is False (never imports the SDK).
try:
    from forail.main.observability import init_observability
    init_observability()
