...
# AWX
from forail.api.generics import APIView, GenericAPIView, ListAPIView, RetrieveUpdateDestroyAPIView
from forail.api.permissions import IsSystemAdminOrAuditor
from forail.api.versioning import reverse
from forail.main.utils import camelcase_to_underscore
from forail.main.tasks.system import clear_setting_cache
from forail.conf.models import Setting
from forail.conf.serializers import SettingCategorySerializer, SettingSingletonSerializer
from forail.conf import settings_registry
from forail.main.utils.external_logging import reconfigure_rsyslog
...
class SettingLoggingTest(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if default_logger != 'forail':
                default_logger = f'forail.analytics.{default_logger}'
        except IndexError:
            default_logger = 'forail'
        logging.getLogger(default_logger).error('Forail Connection Test Message')
