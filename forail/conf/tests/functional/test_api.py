...
def test_setting_singleton_update(api_request, dummy_setting):
    with dummy_setting('FOO_BAR', field_class=fields.IntegerField, category='FooBar', category_slug='foobar'), mock.patch('forail.conf.views.clear_setting_cache'):
...
def test_setting_singleton_update_hybriddictfield_with_forbidden(api_request, dummy_setting):
    ...
    with dummy_setting('FOO_BAR', field_class=sso_fields.SAMLOrgAttrField, category='FooBar', category_slug='foobar'), mock.patch(
        'forail.conf.views.clear_setting_cache'
    ):
        api_request(
            'patch',
...
def test_setting_singleton_update_runs_custom_validate(api_request, dummy_setting, dummy_validate):
    ...
    ), mock.patch('forail.conf.views.clear_setting_cache'):
