...
logger = logging.getLogger('forail.conf.signals')
...
def disable_local_auth(**kwargs):
    if (kwargs['setting'], kwargs['value']) == ('DISABLE_LOCAL_AUTH', True):
        ...
        from forail.main.models.oauth import OAuth2AccessToken
        from forail.main.management.commands.revoke_oauth2_tokens import revoke_tokens
