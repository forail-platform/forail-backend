...
# AWX
from forail.main.models import UnifiedJob, UnifiedJobTemplate, User, Role, Credential, WorkflowJobTemplateNode, WorkflowApprovalTemplate
from forail.main.models.rbac import give_creator_permissions
from forail.main.access import optimize_queryset
from forail.main.utils import camelcase_to_underscore, get_search_fields, getattrd, get_object_or_400, decrypt_field, get_awx_version
from forail.main.utils.licensing import server_product_name
from forail.main.utils.proxy import is_proxy_in_headers, delete_headers_starting_with_http
from forail.main.views import ApiErrorView
from forail.api.serializers import ResourceAccessListElementSerializer, CopySerializer
from forail.api.versioning import URLPathVersioning
from forail.api.metadata import SublistAttachDetatchMetadata, Metadata
...
logger = logging.getLogger('forail.api.generics')
analytics_logger = logging.getLogger('forail.analytics.performance')
...
def get_default_schema():
    if settings.SETTINGS_MODULE == 'forail.settings.development':
        from forail.api.swagger import AutoSchema
...
class APIView(views.APIView):
    ...
    def finalize_response(self, request, response, *args, **kwargs):
        ...
        #
        if response.status_code == 404 and 'forail.named_url_rewritten' in request.environ:
        ...
        if getattr(self, 'deprecated', False):
            response['Warning'] = '299 forail "This resource has been deprecated and will be removed in a future release."'
...
def trigger_delayed_deep_copy(*args, **kwargs):
    from forail.main.tasks.system import deep_copy_model_obj
