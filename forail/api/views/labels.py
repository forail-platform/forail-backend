# AWX
from forail.api.generics import SubListCreateAttachDetachAPIView, RetrieveUpdateAPIView, ListCreateAPIView
from forail.main.models import Label
from forail.api.serializers import LabelSerializer
