...
# AWX
from forail.main.models import ActivityStream, Inventory, JobTemplate, Role, User, InstanceGroup, InventoryUpdateEvent, InventoryUpdate
...
logger = logging.getLogger('forail.api.views.organization')
