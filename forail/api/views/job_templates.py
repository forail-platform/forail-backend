...
from forail.main.utils import extract_ansible_vars, getattrd
...
from forail.api.views.mixin import RelatedJobsPreventDeleteMixin
from forail.api.permissions import JobTemplateCallbackPermission
...
class JobTemplateSurveySpec(GenericAPIView):
    ...
    def _validate_spec_data(new_spec, old_spec):
        from forail.main.constants import SURVEY_TYPE_MAPPING
        from forail.main.utils.encryption import encrypt_value
        from forail.main.services.dynamic_survey import validate_dynamic_choices_config
...
class JobTemplateSurveyDynamicChoices(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        from forail.main.services.dynamic_survey import resolve_dynamic_choices
