...
from forail.api.generics import LoggedLoginView, LoggedLogoutView
from forail.api.views.root import (
    ApiRootView,
    ApiV2RootView,
    ApiV2PingView,
    ApiV2ConfigView,
...
from forail.api.views.bulk import (
    BulkView,
    BulkHostCreateView,
    BulkHostDeleteView,
    BulkJobLaunchView,
...
from forail.api.views.mesh_visualizer import MeshVisualizer

from forail.api.views.metrics import MetricsView
from forail.api.views.analytics import AWX_ANALYTICS_API_PREFIX
...
from .forail_analytics import urls as forail_analytics_urls
...
v2_urls = [
    ...
    re_path(r'^hosts/(?P<pk>[0-9]+)/drift/$', __import__('forail.api.views.drift', fromlist=['HostDriftHistory']).HostDriftHistory.as_view(), name='host_drift_history'),
    ...
    re_path(r'^settings/', include('forail.conf.urls')),
    ...
    re_path(r'^forail_analytics/', include(forail_analytics_urls)),
...
if MODE == 'development':
    ...
    from forail.api.swagger import schema_view

    from forail.api.urls.debug import urls as debug_urls
