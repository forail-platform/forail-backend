...
from forail.sso.ldap_group_types import PosixUIDGroupType  # noqa

# AWX
from forail.conf import fields
from forail.main.validators import validate_certificate
from forail.sso.validators import (  # noqa
    validate_ldap_dn,
...
def find_class_in_modules(class_name):
    ...
    """
    module_search_space = [django_auth_ldap.config, forail.sso.ldap_group_types]
...
class AuthenticationBackendsField(fields.StringListField):
    ...
    REQUIRED_BACKEND_SETTINGS = collections.OrderedDict(
        [
            ('forail.sso.backends.LDAPBackend', ['AUTH_LDAP_SERVER_URI']),
            ('forail.sso.backends.LDAPBackend1', ['AUTH_LDAP_1_SERVER_URI']),
            ('forail.sso.backends.LDAPBackend2', ['AUTH_LDAP_2_SERVER_URI']),
            ('forail.sso.backends.LDAPBackend3', ['AUTH_LDAP_3_SERVER_URI']),
            ('forail.sso.backends.LDAPBackend4', ['AUTH_LDAP_4_SERVER_URI']),
            ('forail.sso.backends.LDAPBackend5', ['AUTH_LDAP_5_SERVER_URI']),
            ('forail.sso.backends.RADIUSBackend', ['RADIUS_SERVER']),
            ...
            ('forail.main.backends.AWXModelBackend', []),
        ]
    )
