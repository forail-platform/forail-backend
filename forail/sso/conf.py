...
# AWX
from forail.conf import register, register_validate, fields
from forail.sso.fields import (
...
from forail.main.validators import validate_private_key, validate_certificate
from forail.sso.validators import validate_ldap_bind_dn, validate_tacacsplus_disallow_nonascii  # noqa
...
if settings.ALLOW_LOCAL_RESOURCE_MANAGEMENT:
    ...
    register(
        ...
        help_text=_('JSON map describing how OIDC users are placed into Forail organizations. Same shape as the SAML org map.'),
        category=_('OIDC'),
        category_slug='oidc',
    )
    register(
        ...
        help_text=_('JSON map describing how OIDC users are placed into Forail teams. Same shape as the SAML team map.'),
        category=_('OIDC'),
        category_slug='oidc',
    )
