...
from forail.sso.backends import LDAPSettings
from forail.sso.validators import validate_ldap_filter
from django.core.cache import cache


def test_ldap_default_settings(mocker):
    from_db = mocker.Mock(**{'order_by.return_value': []})
    mocker.patch('forail.conf.models.Setting.objects.filter', return_value=from_db)
