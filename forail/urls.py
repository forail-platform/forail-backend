...
from forail.main.views import handle_400, handle_403, handle_404, handle_500, handle_csp_violation, handle_login_redirect
...
def get_urlpatterns(prefix=None):
    ...
    urlpatterns += [
        ...
        re_path(r'^sso/', include('forail.sso.urls', namespace='sso')),
...
handler400 = 'forail.main.views.handle_400'
handler403 = 'forail.main.views.handle_403'
handler404 = 'forail.main.views.handle_404'
handler500 = 'forail.main.views.handle_500'
