...
logger = logging.getLogger('forail.main.tenancy.quota')
...
def check_tenant_quota(unified_job, request):
    ...
    from forail.main.models.tenancy import TenantUsage, TenantQuotaEvent
    ...
    with transaction.atomic():
        ...
        for kind, current, limit in checks:
            if not check_quota_value(current, limit):
                ...
                try:
                    from forail.main.observability.metrics import inc_tenant_quota_blocks
