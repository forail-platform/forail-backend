...
from forail.main.constants import (
...
from forail.main.tasks.callback import (
    RunnerCallback,
...
from forail.main.tasks.signals import with_signal_handling, signal_callback
from forail.main.tasks.receptor import AWXReceptorJob
from forail.main.tasks.facts import start_fact_cache, finish_fact_cache
from forail.main.exceptions import AwxTaskError, PostRunError, ReceptorNodeNotFound
from forail.main.utils.ansible import read_ansible_config
from forail.main.utils.execution_environments import CONTAINER_ROOT, to_container_path
from forail.main.utils.safe_yaml import safe_dump, sanitize_jinja
...
from forail.conf.license import get_license
from forail.main.utils.handlers import SpecialInventoryHandler
from forail.main.tasks.system import update_smart_memberships_for_inventory, update_inventory_computed_fields
from forail.main.utils.update_model import update_model
from rest_framework.exceptions import PermissionDenied
from django.utils.translation import gettext_lazy as _

logger = logging.getLogger('forail.main.tasks.jobs')
...
class RunJob(SourceControlMixin, BaseTask):
    ...
    def post_run_hook(self, job, status):
        ...
        if self.should_use_fact_cache() and self.runner_callback.artifacts_processed:
            ...
            from forail.main.tasks.drift import capture_fact_snapshot
...
class RunInventoryUpdate(SourceControlMixin, BaseTask):
    ...
    def post_run_hook(self, inventory_update, status):
        ...
        inv_logger = logging.getLogger('forail.main.commands.inventory_import')
        formatter = inv_logger.handlers[0].formatter
        formatter.job_start = inventory_update.started
        handler.formatter = formatter
        inv_logger.handlers[0] = handler

        from forail.main.management.commands.inventory_import import Command as InventoryImportCommand
