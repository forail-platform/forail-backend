...
from forail.main.models.inventory import Host


logger = logging.getLogger('forail.main.tasks.facts')
system_tracking_logger = logging.getLogger('forail.analytics.system_tracking')
