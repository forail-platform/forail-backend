...
# AWX
from forail.main.redact import UriCleaner
from forail.main.constants import MINIMAL_EVENTS, ANSIBLE_RUNNER_NEEDS_UPDATE_MESSAGE
from forail.main.utils.update_model import update_model
from forail.main.queue import CallbackQueueDispatcher

logger = logging.getLogger('forail.main.tasks.callback')
    ...
    def status_handler(self, status_data, runner_config):
        ...
        if status_data['status'] == 'starting':
            ...
            for k, v in self.safe_env.items():
                if k in job_env:
                    job_env[k] = v
            from forail.main.signals import disable_activity_stream  # Circular import
