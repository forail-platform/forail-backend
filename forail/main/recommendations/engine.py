...
def build_context() -> RuleContext:
    ...
    # Schedules
    def _schedules():
        from forail.main.models import Schedule
        return Schedule.objects.count()
    ctx.schedules_total = _safe(_schedules, 0)

    # Catalog items
    def _catalog():
        from forail.main import models as m
    ...
    # Projects
    def _projects():
        from forail.main.models import Project
        out = []
    ...
    # Teams
    def _teams():
        from forail.main.models import Team
        return Team.objects.count()
    ctx.teams_count = _safe(_teams, 0)

    # Admin default password
    def _admin_default():
        from forail.main.models import User
