...
from forail.settings.development import *  # NOQA

# Some things make decisions based on settings.SETTINGS_MODULE, so this is done for that
SETTINGS_MODULE = 'forail.settings.development'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'forail.sqlite3'),  # noqa
        'TEST': {
            # Test database cannot be :memory: for inventory tests.
            'NAME': os.path.join(BASE_DIR, 'forail_test.sqlite3')  # noqa
        },
    }
}
