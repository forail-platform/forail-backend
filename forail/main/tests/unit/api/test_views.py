...
from forail.api.views.root import ApiVersionRootView
from forail.api.views import JobTemplateLabelList, InventoryInventorySourcesUpdate, JobTemplateSurveySpec

from forail.main.views import handle_error
...
class TestJobTemplateLabelList:
    def test_inherited_mixin_unattach(self):
        with mock.patch('forail.api.views.labels.LabelSubListCreateAttachDetachView.unattach') as mixin_unattach:
...
class TestInventoryInventorySourcesUpdate:
    ...
    def test_post(self, mocker, can_update, can_access, is_source, expected):
        ...
        serializer_class = mocker.patch('forail.api.serializers.InventoryUpdateDetailSerializer')
