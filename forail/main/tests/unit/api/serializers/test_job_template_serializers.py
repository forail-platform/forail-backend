...
from forail.api.views import JobTemplateDetail
...
@mock.patch('forail.api.serializers.JobOptionsSerializer.get_related', lambda x, y: {})
...
class TestJobTemplateSerializerGetSummaryFields:
    ...
    def test_copy_edit_standard(self, mocker, job_template_factory):
        ...
        mocker.patch("forail.api.serializers.role_summary_fields_generator", return_value='Can eat pie')
        mocker.patch("forail.main.access.JobTemplateAccess.can_change", return_value='foobar')
        mocker.patch("forail.main.access.JobTemplateAccess.can_copy", return_value='foo')
