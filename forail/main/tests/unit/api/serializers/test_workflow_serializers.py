...
# AWX
from forail.api.serializers import (
    WorkflowJobTemplateSerializer,
    WorkflowJobTemplateNodeSerializer,
    WorkflowJobNodeSerializer,
)
from forail.main.models import Job, WorkflowJobTemplateNode, WorkflowJob, WorkflowJobNode, WorkflowJobTemplate, Project, Inventory, JobTemplate


@pytest.mark.django_db
@mock.patch('forail.api.serializers.UnifiedJobTemplateSerializer.get_related', lambda x, y: {})
...
@mock.patch('forail.api.serializers.BaseSerializer.get_related', lambda x, y: {})
...
@pytest.mark.django_db
@mock.patch('forail.api.serializers.BaseSerializer.validate', lambda self, attrs: attrs)
class TestWorkflowJobTemplateNodeSerializerSurveyPasswords:
    ...
    def test_use_db_answer(self, jt, mocker):
        ...
        mocker.patch('forail.main.models.mixins.decrypt_value', return_value='foo')
...
@mock.patch('forail.api.serializers.WorkflowJobTemplateNodeSerializer.get_related', lambda x, y: {})
