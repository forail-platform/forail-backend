...
from forail.main.access import BaseAccess, check_superuser, JobTemplateAccess, WorkflowJobTemplateAccess, SystemJobTemplateAccess, vars_are_encrypted
...
class TestWorkflowAccessMethods:
    ...
    def test_workflow_can_add(self, workflow, user_unit):
        ...
        with mock.patch('forail.main.models.rbac.Role.__contains__', return_value=True):
            with mock.patch('forail.main.access.base.get_object_or_400', mock_get_object):
