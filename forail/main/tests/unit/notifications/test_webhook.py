...
import forail.main.notifications.webhook_backend as webhook_backend


def test_send_messages_as_POST():
    with mock.patch('forail.main.notifications.webhook_backend.requests') as requests_mock, mock.patch(
        'forail.main.notifications.webhook_backend.get_awx_http_client_headers'
    ) as version_mock:
