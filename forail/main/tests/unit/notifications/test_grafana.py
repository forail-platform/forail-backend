...
import forail.main.notifications.grafana_backend as grafana_backend


def test_send_messages():
    with mock.patch('forail.main.notifications.grafana_backend.requests') as requests_mock:
