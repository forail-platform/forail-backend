...
import forail.main.notifications.awssns_backend as awssns_backend


def test_send_messages():
    with mock.patch('forail.main.notifications.awssns_backend.AWSSNSBackend._sns_publish') as sns_publish_mock:
