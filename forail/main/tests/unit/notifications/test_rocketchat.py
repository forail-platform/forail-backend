...
import forail.main.notifications.rocketchat_backend as rocketchat_backend


def test_send_messages():
    with mock.patch('forail.main.notifications.rocketchat_backend.requests') as requests_mock, mock.patch(
        'forail.main.notifications.rocketchat_backend.get_awx_http_client_headers'
    ) as version_mock:
...
def test_send_messages_with_username():
    with mock.patch('forail.main.notifications.rocketchat_backend.requests') as requests_mock:
        requests_mock.post.return_value.status_code = 201
