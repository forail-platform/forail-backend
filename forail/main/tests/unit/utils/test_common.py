...
from forail.main.utils import common
from forail.api.validators import HostnameRegexValidator

from forail.main.models import Job, AdHocCommand, InventoryUpdate, ProjectUpdate, SystemJob, WorkflowJob, Inventory, JobTemplate, UnifiedJobTemplate, UnifiedJob
...
def memoized_function(mocker, mock_cache):
    with mock.patch('forail.main.utils.common.get_memoize_cache', return_value=mock_cache):
...
def test_memoize_delete(memoized_function, mock_cache):
    ...
    with mock.patch('forail.main.utils.common.memoize_delete', side_effect=mock_cache.delete):
