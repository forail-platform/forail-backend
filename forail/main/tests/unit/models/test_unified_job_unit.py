...
from forail.main.models import UnifiedJob, UnifiedJobTemplate, WorkflowJob, WorkflowJobNode, WorkflowApprovalTemplate, Job, User, Project, JobTemplate, Inventory
...
def test_cancel(unified_job):
    with mock.patch('forail.main.models.unified_jobs.connection.on_commit', wraps=mock_on_commit):
        unified_job.cancel()
...
def test_cancel_job_explanation(unified_job):
    ...
    with mock.patch('forail.main.models.unified_jobs.connection.on_commit'):
