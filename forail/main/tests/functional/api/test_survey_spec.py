...
from forail.main.models.activity_stream import ActivityStream
from forail.main.access import JobTemplateAccess
...
@mock.patch('forail.main.models.unified_jobs.UnifiedJobTemplate.create_unified_job', lambda self, **kwargs: mock.MagicMock(spec=Job, id=968))
@mock.patch('forail.api.serializers.JobSerializer.to_representation', lambda self, obj: {})
@pytest.mark.django_db
@pytest.mark.survey
