...
from forail.main.models import Instance, ReceptorAddress
from forail.api.views.instance_install_bundle import generate_group_vars_all_yml
...
class TestPeers:
    ...
    def test_write_receptor_config_called(self):
        ...
        """
        with mock.patch('forail.main.models.ha.schedule_write_receptor_config') as write_method:
    ...
    def test_write_receptor_config_data(self):
        ...
        """
        from forail.main.tasks.receptor import RECEPTOR_CONFIG_STARTER

        with mock.patch('forail.main.tasks.receptor.read_receptor_config', return_value=list(RECEPTOR_CONFIG_STARTER)):
            from forail.main.tasks.receptor import generate_config_data
