...
from forail.main.access import ActivityStreamAccess
...
def test_rbac_stream_resource_roles(activity_stream_entry, organization, org_admin, settings):
    ...
    assert activity_stream_entry.object_relationship_type == 'forail.main.models.organization.Organization.admin_role'
