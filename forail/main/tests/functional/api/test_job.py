...
from forail.api.views import RelatedJobsPreventDeleteMixin, UnifiedJobDeletionMixin
from forail.main.models import JobTemplate, User, Job, AdHocCommand, ProjectUpdate, InstanceGroup, Label, Organization
...
def test_block_unprocessed_events(delete, admin_user, mocker):
    ...
    with mock.patch('forail.api.views.mixin.now', lambda: time_of_request):
