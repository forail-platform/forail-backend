...
from forail.main.models.inventory import Group, Host
from forail.main.models.ad_hoc_commands import AdHocCommand
from forail.api.pagination import Pagination
...
def test_pagination_cap_page_size(get, admin, inventory):
    ...
    with patch('forail.api.pagination.Pagination.max_page_size', 5):
