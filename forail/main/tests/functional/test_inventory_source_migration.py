...
from forail.main.migrations import _inventory_source as invsrc

from django.apps import apps

from forail.main.models import InventorySource, InventoryUpdate, ManagedCredentialType, CredentialType, Credential
