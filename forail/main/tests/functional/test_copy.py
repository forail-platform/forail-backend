...
from forail.main.models.workflow import WorkflowJobTemplate, WorkflowJobTemplateNode, WorkflowApprovalTemplate
from forail.main.models.jobs import JobTemplate
from forail.main.tasks.system import deep_copy_model_obj
from forail.main.models import Label, ExecutionEnvironment, InstanceGroup
...
def test_inventory_copy(inventory, group_factory, post, get, alice, organization):
    ...
    with mock.patch('forail.api.generics.trigger_delayed_deep_copy') as deep_copy_mock:
