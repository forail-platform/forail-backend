...
# AWX
from forail.main.models import UnifiedJobTemplate, Job, JobTemplate, WorkflowJobTemplate, Project, WorkflowJob, Schedule, Credential
...
class TestCreateUnifiedJob:
    ...
    def test_many_to_many(self, mocker, job_template_labels):
        ...
        _get_unified_job_field_names = mocker.patch('forail.main.models.jobs.JobTemplate._get_unified_job_field_names', return_value=['labels'])
