...
from forail.main.migrations._dab_rbac import setup_managed_role_definitions

# AWX
from forail.main.models.projects import Project
from forail.main.models.ha import Instance, InstanceGroup
...
from forail.main.models.credential import CredentialType, Credential
from forail.main.models.jobs import JobTemplate, SystemJobTemplate
from forail.main.models.inventory import Group, Inventory, InventoryUpdate, InventorySource
from forail.main.models.organization import (
    Organization,
    Team,
)
from forail.main.models.notifications import NotificationTemplate, Notification
from forail.main.models.events import (
    JobEvent,
    AdHocCommandEvent,
    ProjectUpdateEvent,
...
from forail.main.models.workflow import WorkflowJobTemplate
from forail.main.models.ad_hoc_commands import AdHocCommand
from forail.main.models.oauth import OAuth2Application as Application
from forail.main.models.execution_environments import ExecutionEnvironment
from forail.main.utils import is_testing
...
def run_computed_fields_right_away(request):
    ...
    mocked = mock.patch('forail.main.signals.update_inventory_computed_fields.delay', new=run_me)
    mocked.start()
...
def credentialtype_external():
    ...
    with mock.patch('forail.main.models.credential.CredentialType.plugin', new_callable=PropertyMock) as mock_plugin:
...
def scm_inventory_source(inventory, project):
    ...
    with mock.patch('forail.main.models.unified_jobs.UnifiedJobTemplate.update'):
        inv_src.save()
    return inv_src
...
def disable_database_settings(mocker):
    m = mocker.patch('forail.conf.settings.SettingsWrapper.all_supported_settings', new_callable=PropertyMock)
    m.return_value = []
