...
from forail.main.dispatch.worker.callback import job_stats_wrapup, CallbackBrokerWorker

from forail.main.models.jobs import Job
from forail.main.models.inventory import InventoryUpdate, InventorySource
from forail.main.models.events import InventoryUpdateEvent
...
def test_wrapup_does_not_send_notifications(mocker):
    ...
    mock = mocker.patch('forail.main.models.notifications.JobNotificationMixin.send_notification_templates')
...
class TestCallbackBrokerWorker(TransactionTestCase):
    ...
    def turn_off_websockets(self):
        with mock.patch('forail.main.dispatch.worker.callback.emit_event_detail', lambda *a, **kw: None):
            yield
