...
from forail.main.models import WorkflowJobTemplate, JobTemplate, Job
from forail.main.models.ha import Instance
...
def test_single_job_scheduler_launch(hybrid_instance, controlplane_instance_group, job_template_factory, mocker):
    ...
    mocker.patch("forail.main.scheduler.TaskManager.start_task")
...
class TestJobLifeCycle:
    def run_tm(self, tm, expect_channel=None, expect_schedule=None, expect_commit=None):
        ...
        """
        with mock.patch('forail.main.models.unified_jobs.UnifiedJob.websocket_emit_status') as mock_channel:
            with mock.patch('forail.main.utils.common.ScheduleManager._schedule') as tm_sch:
...
def test_multi_jt_capacity_blocking(hybrid_instance, job_template_factory, mocker):
    ...
    tm = TaskManager()
    with mock.patch('forail.main.models.Job.task_impact', new_callable=mock.PropertyMock) as mock_task_impact:
...
def test_single_job_dependencies_project_launch(controlplane_instance_group, job_template_factory, mocker):
    ...
    with mock.patch("forail.main.scheduler.TaskManager.start_task"):
