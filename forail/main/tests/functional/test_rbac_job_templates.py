...
from forail.main.access import BaseAccess, JobTemplateAccess, ScheduleAccess
from forail.main.models.jobs import JobTemplate
from forail.main.models import Project, Organization, Schedule
...
class TestJobTemplateSchedules:
    ...
    def test_prompts_access_checked(self, job_template, inventory, credential, rando):
        ...
        with mock.patch('forail.main.access.JobLaunchConfigAccess.can_add') as mock_add:
        ...
        with mock.patch('forail.main.access.JobLaunchConfigAccess.can_change') as mock_change:
