...
from forail.main.credential_plugins import hashivault


def test_imported_azure_cloud_sdk_vars():
    from forail.main.credential_plugins import azure_kv
...
class TestDelineaImports:
    ...
    def test_dsv_import(self):
        from forail.main.credential_plugins.dsv import SecretsVault  # noqa
    ...
    def test_tss_import(self):
        from forail.main.credential_plugins.tss import DomainPasswordGrantAuthorizer, PasswordGrantAuthorizer, SecretServer, ServerSecret  # noqa
