...
from forail.main.models import Credential, UnifiedJob, Instance
from forail.main.tests.factories import (
    create_organization,
    create_job_template,
    create_instance,
...
def mock_access():
    ...
    def access_given_class(TowerClass):
        try:
            ...
            the_patch = mock.patch.dict('forail.main.access.access_registry', {TowerClass: MockAccess}, clear=False)
            the_patch.__enter__()
            yield mock_instance
        finally:
            the_patch.__exit__()
