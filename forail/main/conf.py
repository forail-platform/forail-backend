...
# AWX
from forail.conf import fields, register, register_validate
from forail.main.models import ExecutionEnvironment
from forail.main.constants import SUBSCRIPTION_USAGE_MODEL_UNIQUE_HOSTS

logger = logging.getLogger('forail.main.conf')
...
register(
    ...
    field_class=fields.StringListField,
    default=['forail', 'activity_stream', 'job_events', 'system_tracking', 'broadcast_websocket'],
...
register(
    ...
    help_text=_(
        ...
        'forail.anlytics ignore this setting)'
    ),
    category=_('Logging'),
    category_slug='logging',
)
...
register(
    ...
    field_class=fields.CharField,
    allow_blank=True,
    default='http://forail-opa:8181',
    label=_('OPA Server URL'),
    help_text=_('Base URL of the OPA Data API (sidecar). Reachable from forail-web.'),
    category=_('Security'),
    category_slug='security',
)
...
register(
    ...
    field_class=fields.CharField,
    allow_blank=True,
    default='http://forail-otel-collector:4317',
...
register(
    ...
    help_text=_(
        ...
        'When True, the middleware sets forail.current_tenant_id per request '
