...
from forail.main.migrations import _migration_utils as migration_utils
from forail.main.migrations._multi_cred import migrate_workflow_cred, migrate_workflow_cred_reverse
from forail.main.migrations._scan_jobs import remove_scan_type_nodes
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data', forail.main.fields.JSONBlob(blank=True, default=dict)),
                ('survey_passwords', forail.main.fields.JSONBlob(blank=True, default=dict, editable=False)),
                ('char_prompts', forail.main.fields.JSONBlob(blank=True, default=dict)),
        ...
        migrations.AddField(
            ...
            field=forail.main.fields.AskForField(blank=True, default=False),
        ),
