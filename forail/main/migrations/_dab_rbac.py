...
from forail.main.constants import role_name_to_perm_mapping

from ansible_base.rbac.permission_registry import permission_registry


logger = logging.getLogger('forail.main.migrations._dab_rbac')
...
def migrate_to_new_rbac(apps, schema_editor):
    ...
    from forail.main.models.rbac import role_descriptions
