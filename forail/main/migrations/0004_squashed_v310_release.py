...
import forail.main.models.notifications
import django.db.models.deletion
import forail.main.models.workflow
...
class Migration(migrations.Migration):
    ...
    operations = _squashed.operations(SQUASHED_30) + [
        ...
        migrations.CreateModel(
            ...
            bases=('main.unifiedjob', models.Model, forail.main.models.notifications.JobNotificationMixin),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_vars', models.TextField(default='', blank=True)),
                ('admin_role', forail.main.fields.ImplicitRoleField(related_name='+', parent_role='singleton:system_administrator', to='main.Role', null='True')),
            ],
        ...
        migrations.AddField(
            model_name='job',
            name='artifacts',
            field=forail.main.fields.JSONBlob(default=dict, editable=False, blank=True),
        ),
        migrations.AddField(
            model_name='workflowjobnode',
        ...
        migrations.AddField(
            model_name='project',
            name='playbook_files',
            field=forail.main.fields.JSONBlob(
        ...
        migrations.AlterField(
            ...
            field=forail.main.fields.JSONBlob(default=dict),
        ),
        migrations.AlterField(
            model_name='project',
            name='playbook_files',
