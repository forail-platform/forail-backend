...
logger = logging.getLogger('forail.main.policy.sync')
...
def push_policy(policy):
    ...
    from forail.main.policy.opa_client import upload_policy, OPAUnavailable
...
def remove_policy(policy_id):
    from forail.main.policy.opa_client import delete_policy, OPAUnavailable
    try:
