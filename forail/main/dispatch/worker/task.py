...
from forail.main.tasks.system import dispatch_startup, inform_cluster_of_shutdown
    ...
    def perform_work(self, body):
        ...
        body = {
            ...
            'callbacks': [{
                'args': [],
                'kwargs': {}
                'task': u'forail.main.tasks.system.handle_work_success'
            }],
            'errbacks': [{
                'args': [],
                'kwargs': {},
                'task': 'forail.main.tasks.system.handle_work_error'
            }],
            'kwargs': {},
            'task': u'forail.main.tasks.jobs.RunProjectUpdate'
        }
        """
