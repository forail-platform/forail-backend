...
from forail.main.dispatch.pool import WorkerPool
from forail.main.dispatch.periodic import Scheduler
from forail.main.dispatch import pg_bus_conn
from forail.main.utils.common import log_excess_runtime
from forail.main.utils.db import set_connection_name
...
if 'run_callback_receiver' in sys.argv:
    ...
    logger = logging.getLogger('forail.main.dispatch')
