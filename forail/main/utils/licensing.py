...
class Licenser(object):
    ...
    def validate(self):
        ...
        from forail.main.models import Host, HostMetric, Instance
...
def get_licenser(*args, **kwargs):
    from forail.main.utils.licensing import Licenser, OpenLicense
...
def server_product_name():
    return 'Forail' if isinstance(get_licenser(), OpenLicense) else 'Red Hat Ansible Automation Platform'
