...
from forail.main.models.inventory import Inventory, InventorySource, InventoryUpdate, Host
from forail.main.utils.mem_inventory import MemInventory, dict_to_mem_data
from forail.main.utils.safe_yaml import sanitize_jinja

# other AWX imports
from forail.main.models.rbac import batch_role_ancestor_rebuilding
from forail.main.utils import ignore_inventory_computed_fields, get_licenser
from forail.main.utils.execution_environments import get_default_execution_environment
from forail.main.signals import disable_activity_stream
from forail.main.constants import STANDARD_INVENTORY_UPDATE_ENV
from forail.main.utils.pglock import advisory_lock

logger = logging.getLogger('forail.main.commands.inventory_import')
