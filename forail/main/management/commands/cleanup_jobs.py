...
# AWX
from forail.main.models import Job, AdHocCommand, ProjectUpdate, InventoryUpdate, SystemJob, WorkflowJob, Notification
from forail.main.utils import unified_job_class_to_event_table_name
...
class Command(BaseCommand):
    ...
    def init_logging(self):
        ...
        self.logger = logging.getLogger('forail.main.commands.cleanup_jobs')
