...
# AWX
from forail.main.utils.filters import SmartFilter
from forail.main.utils.encryption import encrypt_value, decrypt_value, get_encryption_key
from forail.main.validators import validate_ssh_private_key
from forail.main.constants import ENV_BLOCKLIST
from forail.main import utils
...
logger = logging.getLogger('forail.main.fields')
...
class ImplicitRoleField(models.ForeignKey):
    ...
    def _post_save(self, instance, created, *args, **kwargs):
        ...
        # Avoid circular import
        from forail.main.models.rbac import batch_role_ancestor_rebuilding, Role
    ...
    def _post_delete(self, instance, *args, **kwargs):
        ...
        # Avoid circular import
        from forail.main.models.rbac import Role
