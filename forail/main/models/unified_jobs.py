...
# AWX
from forail.main.models.base import CommonModelNameNotUnique, PasswordFieldsModel, NotificationFieldsModel
from forail.main.dispatch import get_task_queuename
from forail.main.dispatch.control import Control as ControlDispatcher
from forail.main.registrar import activity_stream_registrar
from forail.main.models.mixins import TaskManagerUnifiedJobMixin, ExecutionEnvironmentMixin
from forail.main.models.rbac import to_permissions
from forail.main.utils.common import (
...
from forail.main.utils.encryption import encrypt_dict, decrypt_field
from forail.main.utils import polymorphic
from forail.main.constants import ACTIVE_STATES, CAN_CANCEL, JOB_VARIABLE_PREFIXES
from forail.main.redact import UriCleaner, REPLACE_STR
from forail.main.consumers import emit_channel_notification
from forail.main.fields import AskForField, OrderedManyToManyField

__all__ = ['UnifiedJobTemplate', 'UnifiedJob', 'StdoutMaxBytesExceeded']

logger = logging.getLogger('forail.main.models.unified_jobs')
logger_job_lifecycle = logging.getLogger('forail.analytics.job_lifecycle')
...
class UnifiedJobTemplate(PolymorphicModel, CommonModelNameNotUnique, ExecutionEnvironmentMixin, NotificationFieldsModel):
    ...
    def create_unified_job(self, instance_groups=None, **kwargs):
        ...
        from forail.main.signals import disable_activity_stream, activity_stream_create
...
class UnifiedJob(
    ...
    def result_stdout_raw_handle(self, enforce_max_bytes=True):
        ...
        if enforce_max_bytes:
            ...
            from forail.main.tasks.system import purge_old_stdout_files  # circular import
    ...
    def control_plane_instance_group(self):
        from forail.main.models.ha import InstanceGroup
    ...
    def get_queue_name(self):
        ...
        from forail.main.tenancy.queues import get_queue_for_job
