...
from forail.main.models.base import AD_HOC_JOB_TYPE_CHOICES, VERBOSITY_CHOICES, VarsDictProperty
from forail.main.models.events import AdHocCommandEvent, UnpartitionedAdHocCommandEvent
from forail.main.models.unified_jobs import UnifiedJob
from forail.main.models.notifications import JobNotificationMixin, NotificationTemplate

logger = logging.getLogger('forail.main.models.ad_hoc_commands')
...
class AdHocCommand(UnifiedJob, JobNotificationMixin):
    ...
    def _get_task_class(cls):
        from forail.main.tasks.jobs import RunAdHocCommand
