...
from forail.main.managers import InstanceManager, UUID_DEFAULT
from forail.main.constants import JOB_FOLDER_PREFIX
from forail.main.models.base import BaseModel, HasEditsMixin
from forail.main.models.rbac import (
    ROLE_SINGLETON_SYSTEM_ADMINISTRATOR,
    ROLE_SINGLETON_SYSTEM_AUDITOR,
)
from forail.main.models.unified_jobs import UnifiedJob
from forail.main.utils.common import get_corrected_cpu, get_cpu_effective_capacity, get_corrected_memory, get_mem_effective_capacity
from forail.main.models.mixins import RelatedJobsMixin, ResourceMixin
from forail.main.models.receptor_address import ReceptorAddress
...
logger = logging.getLogger('forail.main.models.ha')
...
def schedule_write_receptor_config(broadcast=True):
    from forail.main.tasks.receptor import write_receptor_config  # prevents circular import
...
def on_instance_saved(sender, instance, created=False, raw=False, **kwargs):
    ...
    if settings.IS_K8S and instance.node_type in [Instance.Types.HOP, Instance.Types.EXECUTION]:
        if instance.node_state == Instance.States.DEPROVISIONING:
            from forail.main.tasks.receptor import remove_deprovisioned_node  # prevents circular import
