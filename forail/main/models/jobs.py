...
from forail.main.constants import HOST_FACTS_FIELDS
from forail.main.models.base import (
    BaseModel,
...
from forail.main.models.events import JobEvent, UnpartitionedJobEvent, UnpartitionedSystemJobEvent, SystemJobEvent
from forail.main.models.unified_jobs import UnifiedJobTemplate, UnifiedJob
from forail.main.models.notifications import (
    NotificationTemplate,
    JobNotificationMixin,
)
from forail.main.utils import parse_yaml_or_json, getattr_dne, NullablePromptPseudoField, polymorphic
from forail.main.fields import ImplicitRoleField, AskForField, JSONBlob, OrderedManyToManyField
...
logger = logging.getLogger('forail.main.models.jobs')
...
class JobTemplate(UnifiedJobTemplate, JobOptions, SurveyJobTemplateMixin, ResourceMixin, CustomVirtualEnvMixin, RelatedJobsMixin, WebhookTemplateMixin):
    ...
    def create_unified_job(self, **kwargs):
        ...
        if slice_event:
            ...
            from forail.main.models.workflow import WorkflowJobTemplate, WorkflowJobNode
...
class Job(UnifiedJob, JobOptions, SurveyJobMixin, JobNotificationMixin, TaskManagerJobMixin, CustomVirtualEnvMixin, WebhookMixin):
    ...
    def _get_task_class(cls):
        from forail.main.tasks.jobs import RunJob
...
class SystemJob(UnifiedJob, SystemJobOptions, JobNotificationMixin):
    ...
    @classmethod
    def _get_task_class(cls):
        from forail.main.tasks.jobs import RunSystemJob
