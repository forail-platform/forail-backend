...
from forail.main.models.base import PROJECT_UPDATE_JOB_TYPE_CHOICES, PERM_INVENTORY_DEPLOY
from forail.main.models.events import ProjectUpdateEvent, UnpartitionedProjectUpdateEvent
from forail.main.models.notifications import (
    NotificationTemplate,
    JobNotificationMixin,
)
from forail.main.models.unified_jobs import (
    UnifiedJob,
    UnifiedJobTemplate,
)
from forail.main.models.jobs import Job
from forail.main.models.mixins import ResourceMixin, TaskManagerProjectUpdateMixin, CustomVirtualEnvMixin, RelatedJobsMixin
from forail.main.utils import update_scm_url, polymorphic
from forail.main.utils.ansible import skip_directory, could_be_inventory, could_be_playbook
from forail.main.utils.execution_environments import get_control_plane_execution_environment
    ...
    def delete(self, *args, **kwargs):
        ...
        for path_to_delete in paths_to_delete:
            if self.scm_type and path_to_delete:  # non-manual, concrete path
                from forail.main.tasks.system import delete_project_files
...
class ProjectUpdate(UnifiedJob, ProjectOptions, JobNotificationMixin, TaskManagerProjectUpdateMixin):
    ...
    def _get_task_class(cls):
        from forail.main.tasks.jobs import RunProjectUpdate
