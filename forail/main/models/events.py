...
from forail.main.fields import JSONBlob
from forail.main.managers import DeferJobCreatedManager
from forail.main.constants import MINIMAL_EVENTS
from forail.main.models.base import CreatedModifiedModel
from forail.main.utils import ignore_inventory_computed_fields, camelcase_to_underscore

analytics_logger = logging.getLogger('forail.analytics.job_events')

logger = logging.getLogger('forail.main.models.events')
...
class JobEvent(BasePlaybookEvent):
    ...
    def _update_host_summary_from_stats(self, hostnames):
        with ignore_inventory_computed_fields():
            ...
            from forail.main.models import Host, JobHostSummary  # circular import
    ...
    def _update_host_metrics(updated_hosts_list):
        from forail.main.models import HostMetric  # circular import
