...
from forail.main.utils import encrypt_field, decrypt_field, set_environ
from forail.main.notifications.email_backend import CustomEmailBackend
from forail.main.notifications.slack_backend import SlackBackend
from forail.main.notifications.twilio_backend import TwilioBackend
from forail.main.notifications.pagerduty_backend import PagerDutyBackend
from forail.main.notifications.webhook_backend import WebhookBackend
from forail.main.notifications.mattermost_backend import MattermostBackend
from forail.main.notifications.grafana_backend import GrafanaBackend
from forail.main.notifications.rocketchat_backend import RocketChatBackend
from forail.main.notifications.irc_backend import IrcBackend
from forail.main.notifications.awssns_backend import AWSSNSBackend


logger = logging.getLogger('forail.main.models.notifications')
...
class JobNotificationMixin(object):
 ...
 'created_by': 'admin'}""",
    ...
    def build_notification_message(self, nt, status):
        ...
        from forail.api.serializers import UnifiedJobSerializer
    ...
    def send_notification_templates(self, status):
        from forail.main.tasks.system import send_notifications  # avoid circular import
