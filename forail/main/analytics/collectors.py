...
from forail.main.utils import get_awx_version, camelcase_to_underscore, datetime_hook
from forail.main import models
from forail.main.analytics import register
...
def host_metric_slicing(key, since, until, last_gather, **kwargs):
    ...
    """
    from forail.main.models.inventory import HostMetric
