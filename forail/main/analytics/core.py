...
from forail.main.models import Job
from forail.main.access import access_registry
from forail.main.utils import get_awx_http_client_headers, set_environ, datetime_hook
from forail.main.utils.pglock import advisory_lock

__all__ = ['register', 'gather', 'ship']


logger = logging.getLogger('forail.main.analytics')
...
def all_collectors():
    from forail.main.analytics import collectors
