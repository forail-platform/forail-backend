...
from forge.api.serializers.eda import (
    EventRuleSerializer,
...
logger = logging.getLogger('forge.api.views.eda')
...
class EventRuleTest(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        from forge.main.tasks.eda import _evaluate_conditions
...
class OutboundWebhookTest(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        from forge.main.tasks.eda import send_outbound_webhook
        ...
        test_data = {
            ...
            'message': 'This is a test webhook from Forge EDA.',
        }
...
class EDAWebhookReceiver(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        for key in ('HTTP_X_HUB_SIGNATURE', 'HTTP_X_HUB_SIGNATURE_256',
                     ...
                     'HTTP_X_FORGE_SIGNATURE', 'CONTENT_TYPE',
        ...
        from forge.main.tasks.eda import evaluate_event_rule
